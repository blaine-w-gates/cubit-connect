        ...
        <div className="w-full relative py-8">
            ...
            <AnimatePresence>
                {isUnlocked && (
                    ...
                    >
                        <div className="border-4 border-red-700 text-red-700 px-4 py-2 font-black text-4xl font-serif tracking-widest uppercase opacity-80 rounded-md" style={{ transform: "rotate(-12deg)" }}>
                            PROCESSED
                        </div>
                    </motion.div>
                )}
