...
export default function UploadZone({ onVideoSelected, onTranscriptParsed, footerContent }: UploadZoneProps) {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 animate-in fade-in zoom-in duration-300">
                        ...
                        >
                            ...
                            <div className="p-4 rounded-full bg-zinc-100 dark:bg-zinc-800 mb-4 group-hover:scale-110 transition-transform border border-zinc-200 dark:border-zinc-700">
                                <Video className={videoFile ? "w-8 h-8 text-green-600" : "w-8 h-8 text-zinc-400 dark:text-zinc-500"} />
                            </div>
                            <span className="text-sm font-medium text-zinc-600 dark:text-zinc-300">
                                {videoFile ? videoFile.name : dragActive ? "Drop Video Here" : "Select Video (MP4/WebM)"}
                            </span>
                        </label>
                        ...
                        >
                            ...
                            <div className="p-4 rounded-full bg-zinc-100 dark:bg-zinc-800 mb-4 group-hover:scale-110 transition-transform border border-zinc-200 dark:border-zinc-700">
                                <FileText className={transcriptContent ? "w-8 h-8 text-purple-600" : "w-8 h-8 text-zinc-400 dark:text-zinc-500"} />
                            </div>
                            <span className="text-sm font-medium text-zinc-600 dark:text-zinc-300">
                                {transcriptContent ? "Transcript Loaded" : dragActive ? "Drop VTT Here" : "Select Transcript (VTT)"}
                            </span>
                        </label>
                    </div>
                )}
                ...
                {showHevcWarning && mode === 'video' && (
                    <div className="w-full max-w-sm bg-amber-900/30 border border-amber-500/50 p-3 rounded-lg flex items-start gap-3 text-left mb-4 mx-auto">
                        ...
                        <div className="text-sm text-amber-200">
                            <span className="font-bold">iPhone/HEVC Detected:</span> This video format may show a black screen.
                        </div>
                    </div>
                )}
