...
export default function SettingsDialog() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div
        className={`w-full max-w-md bg-white border rounded-xl p-6 shadow-2xl relative animate-in zoom-in-95 duration-200 ${
          isQuotaMode ? 'border-red-200 ring-4 ring-red-50' : 'border-zinc-200'
        }`}
      >
        <button
        ...
        <button
          ...
          className={`w-full font-bold py-3 rounded-lg flex justify-center transition-all ${
            isQuotaMode
