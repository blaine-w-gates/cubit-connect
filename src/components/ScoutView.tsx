                ...
                {platforms.map((p) => {
                  ...
                  return (
                    <button
                      ...
                      aria-label={
                        p === 'Copy Only'
                          ? 'Switch to Copy Only mode'
                          : `Switch to ${p} search mode`
                      }
                ...
                {storeResults.map((query, idx) => {
                  ...
                  const accentClass =
                    scoutPlatform === 'Instagram'
                      ? 'group-hover:border-pink-300 group-hover:bg-pink-50 dark:group-hover:bg-pink-900/30 group-hover:text-pink-700 dark:group-hover:text-pink-300 dark:group-hover:border-pink-700'
                      : scoutPlatform === 'Reddit'
                        ? 'group-hover:border-orange-300 group-hover:bg-orange-50 dark:group-hover:bg-orange-900/30 group-hover:text-orange-700 dark:group-hover:text-orange-300 dark:group-hover:border-orange-700'
                        : scoutPlatform === 'TikTok'
                          ? 'group-hover:border-black dark:group-hover:border-zinc-500 group-hover:bg-zinc-100 dark:group-hover:bg-zinc-700 group-hover:text-black dark:group-hover:text-white'
                          : scoutPlatform === 'Facebook'
                            ? 'group-hover:border-blue-600 dark:group-hover:border-blue-500 group-hover:bg-blue-50 dark:group-hover:bg-blue-900/30 group-hover:text-blue-800 dark:group-hover:text-blue-300'
                  ...
                  return (
                    ...
                    >
                      <Search
                        className={`w-3 h-3 min-w-[12px] transition-colors ${copiedId === idx ? 'text-green-600' : `text-zinc-400 dark:text-zinc-500 ${iconColor}`}`}
                      />
