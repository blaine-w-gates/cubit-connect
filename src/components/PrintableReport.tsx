...
export const PrintableReport = ({
  ...
  projectType,
  ref,
}: PrintableReportProps & { ref?: React.Ref<HTMLDivElement> }) => {
  ...
  return (
    <div
      ref={ref}
      className="bg-white dark:bg-stone-900 text-black dark:text-stone-200 font-serif print:bg-white print:text-black"
    >
