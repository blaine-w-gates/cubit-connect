...
- [x] **2. Linting CI Pipeline:** Ensure CI explicitly installs eslint dependencies.
- [x] **3. Strict Type Check on Build:** Add `tsc --noEmit` to pre-commit/build pipeline.
...
- [x] **14. Toast Notifications:** Replace `alert()` with `sonner` toasts.
- [x] **15. Drag-and-Drop Reordering:** Implement drag-and-drop for task list.

## Developer Experience (DX) & Maintenance

- [x] **16. Pre-commit Hooks:** Install `husky` for lint/test checks.
